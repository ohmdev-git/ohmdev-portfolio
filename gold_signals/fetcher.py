...
_YF_INTERVAL = {"5m": "5m", "15m": "15m", "1h": "1h", "4h": "1h", "1D": "1d"}
_YF_RANGE    = {"5m": "5d", "15m": "5d", "1h": "7d", "4h": "30d", "1D": "60d"}
...
def fetch_candles(instrument: str, timeframe: str, limit: int = 200) -> list[Candle]:
